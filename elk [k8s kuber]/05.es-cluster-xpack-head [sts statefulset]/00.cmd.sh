...
kubectl create configmap es-certs --from-file=./cm/es/elastic-certificates.p12
...
## kubectl delete cm es-config kibana-config logstash-config logstash-pipeline-config nginx-config es-certs
